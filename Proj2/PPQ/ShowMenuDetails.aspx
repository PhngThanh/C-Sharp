<%@ Page Title="" Language="C#" MasterPageFile="~/PPQ.master" AutoEventWireup="true" CodeBehind="ShowMenuDetails.aspx.cs" Inherits="PPQ.ShowMenuDetails" %>
        ...
        <table>
            <tr>
                ...
                <td style="width: 257px; text-align: right">
                    <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="Order.aspx?type=pizza">Go to Pizza Order Page</asp:HyperLink>
                </td>
            ...
            <tr>
                ...
                <td style="width: 257px; text-align: right">
                    <asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl="ShowMenu.aspx?type=pizza">Back to Pizza ShowMenu Page</asp:HyperLink>
                </td>
                <td style="width: 226px; text-align: right">
