<%@ Page Title="" Language="C#" MasterPageFile="~/PPQ2.master" AutoEventWireup="true" CodeBehind="Admin.aspx.cs" Inherits="PPQ.Admin" %>
...
<table>
    <tr>
        <td height="250">
            ...
            <span style="font-family: 'Times New Roman'; color: red; font-size: 20px;">Phong Vu Thanh</span></p>
            <p style="text-align: justify; font-family: 'Times New Roman'; color: navy; font-size: 20px; vertical-align: middle;">Email:
            <span style="font-family: 'Times New Roman'; color: #0000FF; font-size: 20px;">phongvt12@fpt.edu.vn</span></p>
        </td>
    </tr>
</table>
<hr /><br /><br />
