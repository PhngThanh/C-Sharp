<%@ Page Title="" Language="C#" MasterPageFile="~/PPQ.master" AutoEventWireup="true" CodeBehind="ShowMenu.aspx.cs" Inherits="PPQ.ShowMenu" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:DataList ID="DataList1" runat="server" DataSourceID="SqlDataSource2" 
		...
		<ItemTemplate>
            ...
            <!-- MenuItemID:
                <asp:Label ID="MenuItemIDLabel" runat="server" Text='<%# Eval("MenuItemID") %>' /><br /
            MenuItemType:
                <asp:Label ID="MenuItemTypeLabel" runat="server" Text='<%# Eval("MenuItemType") %>' /><br />>-->
            <b>ItemName:</b>
                <!--<asp:Label ID="ItemNameLabel" runat="server" Text='<%# Eval("ItemName") %>' ForeColor="#FF3300" /><br />-->
            ...
            <b>PizzaToppings:</b>
                <asp:Label ID="PizzaToppingsLabel" runat="server" Text='<%# Eval("PizzaToppings") %>' /><br />
            <b>Description:</b>
