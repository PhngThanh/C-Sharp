<%@ Page Title="" Language="C#" MasterPageFile="~/PPQ.master" AutoEventWireup="true" CodeBehind="Order.aspx.cs" Inherits="PPQ.Order" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/YourCart.aspx" Width="222px">View Your Shopping Cart</asp:HyperLink>
    ...
    <!--
    <asp:DataList ID="DataList2" runat="server" DataKeyField="MenuItemID" 
        DataSourceID="SqlDataSource2" RepeatColumns="2">
        <ItemTemplate>
            MenuItemID:
            <asp:Label ID="MenuItemIDLabel" runat="server" 
                Text='<%# Eval("MenuItemID") %>' />
            <br />
            MenuItemType:
            <asp:Label ID="MenuItemTypeLabel" runat="server" 
                Text='<%# Eval("MenuItemType") %>' />
            <br />
            ItemName:
            <asp:Label ID="ItemNameLabel" runat="server" Text='<%# Eval("ItemName") %>' />
            <br />
            PizzaToppings:
            <asp:Label ID="PizzaToppingsLabel" runat="server" 
                Text='<%# Eval("PizzaToppings") %>' />
            
            <br />
            GraphicFileName:
            <asp:Label ID="GraphicFileNameLabel" runat="server" 
                Text='<%# Eval("GraphicFileName") %>' />
